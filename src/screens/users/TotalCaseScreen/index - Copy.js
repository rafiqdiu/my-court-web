  ...
  return (
    <View   style={styles.mainContainer}>
     <LeftBar>   
        ...
        <LeftBarItem   name = 'New Case Entry'  stack = 'Case'   screen = 'CaseEntry' />
        <LeftBarItem   name = 'Total Case'  stack = 'Case'   screen = 'CaseScreen' />
        <LeftBarItem   name = 'Case Diary'  stack = 'Case'   screen = 'CaseEntry' />    
    </LeftBar>
      ...
      >
            ...
            {({
              ...
              <>
                <View style={styles.FormGroup}>
                  <InputLevel>Division</InputLevel>
                ...
                <View style={styles.FormGroup}>
                  <InputLevel>District</InputLevel>
                  <View style={styles.pickerWrapper}>
                    <Picker
                ...
                <View style={styles.FormGroup}>
                  <InputLevel>Court Type</InputLevel>
                ...
                <View style={styles.FormGroup}>
                   ...
                   onChangeText={handleChange("case_date")}
                   onBlur={handleBlur("case_date")}
       ...
       { Platform.OS === 'web' ? (
                  ...
                  <DateTimePickerModal
                    ...
                    {touched.case_date && errors.case_date ? (
                      <ErrorText>{errors.case_date}</ErrorText>
                    ) : null}
                  </View> 
