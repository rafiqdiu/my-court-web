    ...
    {/* <LeftBar>   
     ...
     {/* <Text style={styles.buttonMiddle}>
      ...
      <ScrollView>
        ...
        <View style={{ backgroundColor:'#1075c7' , borderRadius: 23, height:windowWidth >= 600?180:180, marginBottom:20}}>
        <TouchableOpacity
      ...
      <TouchableOpacity
          ...
          onPress={ ()=>{ navigation.navigate("ড্যাসবোর্ড")}} 
...
export default MobileWebHomeScreen;
