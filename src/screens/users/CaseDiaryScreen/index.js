...
const handleCaselistUpdate = (values, actions) => {
  ...
  return (
    ...
    <LeftBar>   
        ...
        {/* <LeftBarItem    selectcolor='true' name = 'আমার ডায়েরী'  stack = 'মামলা'   screen = 'CaseDiaryScreen' />  */}
        <LeftBarItem    selectcolor='false'  name = 'নতুন মামলা যোগ'  stack = 'মামলা'   screen = 'CaseEntry' />        
        <LeftBarItem    selectcolor='false'  name = 'সকল মামলা ও রেজিস্ট্রার'  stack = 'মামলা'   screen = 'TotalCaseScreen' />
    </LeftBar>
            ...
            {({
              ...
              <>
                ...
                <View style={styles.FormGroup}>
                  <InputLevel>আদালত এর নাম :</InputLevel>
                ...
                <View style={styles.FormGroup}>
                  ...
                  <View style={styles.pickerWrapper}>
                    <Picker
                      ...
                      mode="dropdown"
                    >
                      <Picker.Item label="অধস্তন আদালত নির্বাচন করুন" value="0" />
                ...
                <View style={styles.FormGroup}>
                  ...
                  <View style={styles.pickerWrapper}>
                    <Picker
                      ...
                      mode="dropdown"
                    >
                      <Picker.Item label="মামলার ধরন নির্বাচন করুন" value="0" />
                ...
                <View style={styles.FormGroup}>
                    <InputLevel>শুরু হইতে :</InputLevel>
                   <>
                 ...
                 />
                   { Platform.OS === 'web' ? (  <FontAwesome.Button     name='calendar'  backgroundColor= '#ccd'  color='#000'  style={{ width:30, marginLeft:-5, marginTop: 4}}  onPress={() =>setVisible(true)}></FontAwesome.Button> ):null }
               </View>
                { Platform.OS === 'web' ? (
                  ...
                  <View style={styles.FormGroup}>
                    <InputLevel>শেষ পর্যন্ত :</InputLevel>
                   <>
                   <View style={{ flexDirection:'row'}}>
                   <TextInput
                   style={styles.inputs1} 
                 ...
                 />
                   { Platform.OS === 'web' ? (  <FontAwesome.Button     name='calendar'  backgroundColor= '#ccd'  color='#000'  style={{ width:30, marginLeft:-5, marginTop: 4}}  onPress={() =>setEndVisible(true)}></FontAwesome.Button> ):null }
                   </View>
      ...
      { Platform.OS === 'web'
            ...
            <table>
                ...
                <tr>
                    ...
                    <th>জেলা</th>
                    <th>মামলা নাম্বার</th>
                    <th>বাদী ও বিবাদীর নাম</th>
                    <th>বাদী বিবাদীর পক্ষে</th>
                    <th>অবস্থা</th>
                    <th>পদক্ষেপ</th>
                </tr>
                </thead>
          <tbody>
                    {caseInfo.length > 0 ? (
                      caseInfo.map((item,key) => (
                            ...
                            <tr key={key}>
                                <td style={styles.tdText}>{key+1}</td>
                                <td style={styles.tdText}>{item.district_name_bng}</td>
                                <td style={styles.tdText}>{item.district_name_bng}</td>
                                <td style={styles.tdText}>{item.type_name + ' - ' + item.case_number + '/' + item.case_year}</td>
                                <td style={styles.tdText}>{item.parties_one+" -VS.- "+item.parties_two}</td>
                                <td style={styles.tdText}>{item.parties_behalf_of}</td>
                                <td style={styles.tdText}>{item.status==1?"Pending":"Dismis"}</td>
