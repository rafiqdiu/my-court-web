...
export default function BdlawScreen() {
  
  return (
    <View    style={Platform.OS === 'web' && windowWidth >= 600?globalStyles.mainContainer:globalStyles.mainContainerMobile}>
    <LeftBar>   
    <LeftBarItem  selectcolor='true'  name = 'Home'  stack = 'Settings'   screen = 'SettingsScreen' />
       <LeftBarItem  name = 'Profile'  stack = 'Settings'   screen = 'ProfileScreen' />
       <LeftBarItem   name = 'PasswordChange'  stack = 'Settings'   screen = 'PasswordChangeScreen' />
   </LeftBar>
