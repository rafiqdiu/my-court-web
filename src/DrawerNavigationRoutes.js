...
import MobileWebHomeScreen from './screens/users/MobileWebHomeScreen';
...
const WebHomedForMobile = () => (
  <Stack.Navigator initialRouteName="MobileWebHomeScreen" screenOptions={stackScreenOptions}>
    <Stack.Screen
      name="MobileWebHomeScreen"
      component={MobileWebHomeScreen}
      options={{
        title: 'হোম',
        headerShown: Platform.OS === 'web' && windowWidth >= 600 ? false : true,
      }}
...
const DrawerNavigatorRoutes = (props) => {
  ...
  return Platform.OS === 'web' && windowWidth >= 600 ? (
   ...
   >
       ...
       <> 
       {/* <Tab.Screen name="MobileWebHomeScreen" component={MobileWebHomeScreen} 
           options={{
             tabBarLabel: ({focused, color, size}) => (
               <Text style={{textAlign:'center',fontFamily:'SolaimanLipi', color: focused ? Colors2.top5 : color, fontWeight:'bold', textDecorationLine: focused ?'underline': 'none'}}>হোম</Text>
             ),}}
         />           */}
         <Tab.Screen name="ড্যাসবোর্ড" component={Dashboard} 
           options={{
             tabBarLabel: ({focused, color, size}) => (
               <Text style={{marginLeft:-90, textAlign:'center',fontFamily:'SolaimanLipi', color: focused ? Colors2.top10 : color, fontWeight:'bold', }}>ড্যাসবোর্ড</Text>
             ),}}
         />
          <Tab.Screen name="মামলা"  component={Case}
          options={{
           tabBarLabel: ({focused, color, size}) => (
             <Text style={{marginLeft:-90, textAlign:'center',fontFamily:'SolaimanLipi', color: focused ? Colors2.top10 : color, fontWeight:'bold', }}>মামলা</Text>
           ),}}
         />
         <Tab.Screen name="দৈনিক কার্যতালিকা" component={DailyCaseList} 
          options={{
           tabBarLabel: ({focused, color, size}) => (
             <Text style={{ marginLeft:-80, textAlign:'center',fontFamily:'SolaimanLipi', color: focused ? Colors2.top10 : color, fontWeight:'bold',  }}>দৈনিক কার্যতালিকা</Text>
           ),}}
         /> 
       ...
       <Tab.Screen name="আমার ডায়েরী" component={MySearchList} 
          options={{
           tabBarLabel: ({focused, color, size}) => (
             <Text style={{marginLeft:-80, size:140, textAlign:'center',fontFamily:'SolaimanLipi', color: focused ? Colors2.top10  : color, fontWeight:'bold',   }}>আমার ডায়েরী</Text>
           ),}}
         />
         <Tab.Screen name="মামলা খুজুন" component={MyCase} 
          options={{
           ...
           tabBarLabel: ({focused, color, size}) => (
             <Text style={{marginLeft:-80,  textAlign:'center',fontFamily:'SolaimanLipi',  color: focused ? Colors2.top10 : color,fontWeight:'bold',   }}>মামলা খুজুন</Text>
           ),}}
         />
     {/* <Tab.Screen name="প্রোফাইল" component={Settings}
          options={{
           tabBarLabel: ({focused, color, size}) => (
             <Text style={{textAlign:'center',fontFamily:'SolaimanLipi', color: focused ? Colors2.top5 : color, fontWeight:'bold', textDecorationLine: focused ?'underline': 'none' }}>প্রোফাইল</Text>
           ),}}
         /> */}
       {  isAdmin?     <Tab.Screen name="অ্যাডমিন" component={Admin} 
          options={{
           tabBarLabel: ({focused, color, size}) => (
             <Text style={{marginLeft:-80, textAlign:'center',fontFamily:'SolaimanLipi', color: focused ? Colors2.top5 : color, fontWeight:'bold', textDecorationLine: focused ?'underline': 'none'  }}>অ্যাডমিন</Text>
           ),}}
         />:null}
         {/* <Tab.Screen name="লগ আউট" component={LogOut}  
          options={{
           tabBarLabel: ({focused, color, size}) => (
             <Text style={{textAlign:'center', color: 'red',fontFamily:'SolaimanLipi', fontWeight:'bold', textDecorationLine: focused ?'underline': 'none'  }}>লগ আউট</Text>
           ),}}
         />  */}
   ...
   >
       ...
       <>
       {/* { Platform.OS === 'web'?
         <Drawer.Screen name="MobileWebHomeScreen"  component={WebHomedForMobile}  />: null } */}
      { Platform.OS === 'web'?
         <Drawer.Screen name="ড্যাসবোর্ড" component={Dashboard} />: 
         ...
         <Drawer.Screen name="মামলা খুজুন"   component={MyCase}   
 />
         {/* <Drawer.Screen name="প্রোফাইল" component={Settings}  />    */}
